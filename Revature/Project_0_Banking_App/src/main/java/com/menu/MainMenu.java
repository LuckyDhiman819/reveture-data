...
public class MainMenu {
	...
	public void firstMethod(int a, String type) throws Exception {
		...
		case 1:
			...
			if(accountId==0) {
				...
				if(type=="employees") {
					...
					System.out.println("--------------------------------------");
					System.out.println("Generationg a Employee Id.....Please wait...");
					Thread.sleep(3000);
		...
		case 2:
			...
			System.out.println("Cheaking id and Password...");
			Thread.sleep(3000);
			if(type=="employees")
		...
		case 3:
			...
			if(login.getAccountId() != 0)
				...
				System.out.println("Details are in correct");
...
//			break;
	...
	public static void Menu(String type) {
		...
		int a = 1;
		System.out.println("-------------------------------------------");
		System.out.println("Welcome to 'Lucky's Banking System (India)'");
		System.out.println("-------------------------------------------");
...
//			System.out.println("Press 5, Know about developers - 'Lucky Dhiman'.");
			System.out.println("!!Press 9  key to exit!!");
			System.out.println("Note:- If you don't have an account please make account else login.");
			try {
				a = sc1.nextInt();
			}
			catch(Exception e) {
