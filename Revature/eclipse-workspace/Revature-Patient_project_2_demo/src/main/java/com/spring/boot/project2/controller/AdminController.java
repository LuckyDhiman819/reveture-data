...
public class AdminController 
{
	...
	public ResponseEntity<String> adminSignup(@RequestBody Admin admin) 
	{
		...
		if (adminService.isAdminExists(adminId)) {
			...
			message = "Admin with admin id : " + adminId + " saved successfully";
	...
	public ResponseEntity<String> updatePatient(@RequestBody Patient patient) {
		...
		if (adminService.isPatientExists(patientId)) {
			...
			message="Updation failed,The patient with that patient Id doesnt exists";
			responseEntity = new ResponseEntity<String>(message, HttpStatus.OK);
		}
		return responseEntity;
	}
	...
	@GetMapping("approveAppointment/{appointmentToken}")
