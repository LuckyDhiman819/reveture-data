...
/**
 * Servlet implementation class WithdrawSuccessServlet
 */
public class WithdrawSuccessServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		CustomerWithdraw customerWithdraw = new CustomerWithdraw(1, customerId, amount);
		CustomerService customerService = new CustomerServiceImpl();
		boolean result = customerService.withdrawAmount(customerWithdraw);
		...
		if (result) {
			...
			out.write("<br><br>");
			out.write("<h5>Money Withdrawed for Customer ID " + customerId + " successfully</h5>");
