...
public class AdminServiceImpl implements AdminService 
{
	...
	public boolean adminLogin(int adminId, String password) {
		...
		return adminRepository.adminExistsById(adminId,password);
	...
	@Override
//	@Modifying
//	@Query("UPDATE appointmentdetails ad SET ad.appointmentStatus= 'Approved' where ad.appointmentToken= :appointmentToken ")
