...
public class SignUpServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out = response.getWriter();
	     out.println("<head><link rel=\"stylesheet\" type=\"text/CSS\" href=\"css/bodypart.css\"></head>");

		out.println("<body>");
		response.getWriter().println("<br/><br/><br/><u><i><h2 align=center>"+customerName + ", congratulations you have successfully opened an account in our bank with balance of INR "+" "+balance);
