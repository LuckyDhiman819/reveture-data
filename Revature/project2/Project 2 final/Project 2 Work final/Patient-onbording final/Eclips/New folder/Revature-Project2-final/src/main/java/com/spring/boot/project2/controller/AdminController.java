...
public class AdminController 
{
	...
	public ResponseEntity<String> adminLogin( @PathVariable("adminId") int adminId,@PathVariable("password") String password) 
	{
		ResponseEntity<String> responseEntity = null;
		String message = null;
		if (adminService.adminLogin(adminId,password)) {
	...
	public ResponseEntity<String> resetPassword(@RequestBody ForgetPassowrd forget) {
		ResponseEntity<String> responseEntity = null;
		String message = null;
		Admin admin = new Admin();
		int patientId = forget.getId();
		if (adminService.isAdminExists(patientId)) {
			admin = adminService.viewAdminById(patientId);
			admin.setAdminId(patientId);
...
//		int patientId = patient.getPatientId();
	...
	public ResponseEntity<Doctor> viewDoctorById(@PathVariable("doctorId") int doctorId) {
		ResponseEntity<Doctor> responseEntity = null;
		Doctor doctor = new Doctor();
		if (adminService.isDoctorExists(doctorId)) {
			doctor = adminService.viewDoctorById(doctorId);
