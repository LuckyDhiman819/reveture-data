...
public class PatientController {
	...
	@PostMapping
	public ResponseEntity<String> patientSignup(@RequestBody Patient patient) {
	...
	public ResponseEntity<String> patientLogin(@PathVariable("patientId") int patientId,
			@PathVariable("password") String password) {
		ResponseEntity<String> responseEntity = null;
		String message = null;
		if (patientService.patientLogin(patientId, password)) {
			message = "Login Successfully ";
			responseEntity = new ResponseEntity<String>(message, HttpStatus.OK);
		} else {
			message = "PatientId/Password is incorrect ";
